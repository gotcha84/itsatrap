...
class COMMON_API AABB {
	public:
		...
		bool collidesWithSide(glm::vec3 from, glm::vec3 goTo, AABB player, int buildingId);
		bool collidesWithSidePointer(glm::vec3 from, glm::vec3 goTo, AABB* player, int buildingId);
		...
		glm::vec3 unstuckOffset(AABB player);
